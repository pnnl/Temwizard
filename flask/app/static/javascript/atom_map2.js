...
// pixels_nanometer by pixels by multiplying actual distance by pixels/nanometer
...
var svg = d3.select("#map").append("svg")
    ...
    var svg5 = d3.select("#map2").append("svg")
        .attr("width", x_image(width) + margin.left +margin.right)
        .attr("height", y_image(height) + margin.top + margin.bottom)
        .append("g")
        .attr("transform","translate("+margin.left+","+margin.top+")")
...
var myimage2 = svg5.append('image')
    .attr('xlink:href', image2)
    .attr('width', x_image(width))
    .attr('height', y_image(height))
...
var atom_dot = svg.append('g')
  ...
  .append("circle")
    ...
    .attr("r", 3)
    .style("fill", cat_color(d.sublattice_df))
